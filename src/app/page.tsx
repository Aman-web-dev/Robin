    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <a
            href="https://github.com/Aman-web-dev/Robin/edit/main/README.md"
            className="hover:text-gray-500 dark:hover:text-gray-300 transition"
          >
            Documentation
          </a>
        ...
        <div className="flex items-center space-x-4">
          <Link
            href="/auth/login"
            className="px-4 py-2 text-sm hover:text-gray-500 dark:hover:text-gray-300 transition"
          >
            Log In
          </Link>
          <Link
            href="/auth/signup"
            className="px-4 py-2 text-sm bg-black dark:bg-white text-white dark:text-black rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 transition"
          >
            Sign Up Free
          </Link>
        </div>
      ...
      <div className="container mx-auto px-4 py-16 flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 space-y-8">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-lg">
            Robin is the next-generation API platform for developers to design,
            test, and document APIs faster and more efficiently.
          </p>
          ...
          <div className="bg-white dark:bg-black rounded-lg border border-gray-200 dark:border-gray-800 shadow-lg overflow-hidden">
            ...
            <div className="px-4 py-4">
              <div className="flex space-x-2 mb-4">
                <div className="px-3 py-1 bg-black dark:bg-white text-white dark:text-black rounded-md text-sm font-medium">
                  GET
                </div>
              ...
              <div className="flex space-x-4 border-b border-gray-200 dark:border-gray-800 mb-4">
                <button className="px-4 py-2 border-b-2 border-black dark:border-white text-black dark:text-white">
                  Params
                </button>
                <button className="px-4 py-2 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200">
                  Headers
                </button>
                <button className="px-4 py-2 text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200">
                  Body
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Get started with a free account and experience the future of API
                testing.
              </p>
            </div>
          </div>
